...
Scenario: Build image with server and datasource
    Given s2i build https://github.com/jfdenise/jboss-eap-8-openshift-image from test/test-app-postgres with env and true using 8.1-channel-tests
    | variable                 | value           |
  ...
  Scenario: Build image with server  and datasources
    Given s2i build https://github.com/jfdenise/jboss-eap-8-openshift-image from test/test-app-postgresql-oracle-legacy with env and true using 8.1-channel-tests
    | variable                 | value           |
    | GALLEON_PROVISION_CHANNELS|org.jboss.eap.channels:eap-8.1 |
    | GALLEON_USE_LOCAL_FILE | true |
    | POSTGRESQL_DRIVER_VERSION | 42.2.19 |
 ...
 Scenario: Build image with server  and datasources
    Given s2i build https://github.com/jfdenise/jboss-eap-8-openshift-image from test/test-app-postgresql-oracle with env and true using 8.1-channel-tests
    | variable                 | value           |
    | POSTGRESQL_DRIVER_VERSION | 42.2.19 |
    | ORACLE_DRIVER_VERSION | 19.3.0.0|
    ### PLACEHOLDER FOR CLOUD CUSTOM TESTING ###
