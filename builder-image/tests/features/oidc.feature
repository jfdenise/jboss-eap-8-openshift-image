...
Feature: OIDC tests
   ...
   Scenario: Check oidc subsystem configuration.
     ...
     Given s2i build https://github.com/jfdenise/jboss-eap-8-openshift-image from test/test-app-elytron-oidc-client with env and True using 8.1-channel-tests
       | variable               | value                                            |
  ...
  Scenario: Provision oidc subsystem configuration, legacy.
    Given s2i build https://github.com/jfdenise/jboss-eap-8-openshift-image from test/test-app-elytron-oidc-client-legacy with env and True using 8.1-channel-tests
       | variable               | value                                            |
